...
export default class EditTodo extends Component{
    ...
    constructor(props){
        ...
        // bind methods to this. I don't know why
    ...
    componentDidMount(){
        axios.get('http://localhost:4000/todos/' + this.props.match.params.id).then(response => {
            this.setState({
    ...
    onSubmit(e) {
        ...
        // bring back to list of all items 
                    ...
                    <div className="form-group">
                        ...
                        <div className="form-check">
                            <input type="checkbox" className="form-check-input" id="completedCheckbox" 
                                name="completedCheckbox" onChange={this.onChangeTodoCompleted}
                                checked={this.state.todo_completed} value={this.state.todo_completed}
                            />
